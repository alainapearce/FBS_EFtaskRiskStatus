...
sst_ssd_bfp_anova <- anova(sst_ssd_bfp_mod)
...
# SSD - ED condition
sst_ssd_bfp_EDmod <- lmer(ssd ~ mom_ed + income + sex + age_yr + ED + risk_status_mom + dxa_total_body_perc_fat + (1|sub), data = r01_sst_EDlong)
sst_ssd_bfp_EDanova <- Anova(sst_ssd_bfp_EDmod, test.statistic = 'F')
...
# SSD - PS condition
sst_ssd_bfp_PSmod <- lmer(ssd ~ mom_ed + income + sex + age_yr + PS + risk_status_mom + dxa_total_body_perc_fat + (1|sub), data = r01_sst_PSlong)
sst_ssd_bfp_PSanova <- Anova(sst_ssd_bfp_PSmod, test.statistic = 'F')
...
nback_balacc_bfp_anova <- Anova(nback_balacc_bfp_mod, test.statistic = 'F')
...
nback_dprime_bfp_anova <- Anova(nback_dprime_bfp_mod, test.statistic = 'F')
...
gng_fa_bfp_risk_anova <- anova(gng_fa_bfp_risk_mod)
...
sst_ssrt_bfp_risk_anova <- anova(sst_ssrt_bfp_risk_mod)
...
sst_ssrt_bfp_risk_EDanova <- Anova(sst_ssrt_bfp_risk_EDmod, test.statistic = 'F')
...
sst_ssrt_bfp_risk_PSanova<- Anova(sst_ssrt_bfp_risk_PSmod, test.statistic = 'F')
...
sst_ssd_bfp_risk_anova <- anova(sst_ssd_bfp_risk_mod)
...
sst_ssd_bfp_risk_EDanova <- Anova(sst_ssd_bfp_risk_EDmod, test.statistic = 'F')
...
sst_ssd_bfp_risk_PSanova <- Anova(sst_ssd_bfp_risk_PSmod, test.statistic = 'F')
...
# balanced accuracy
nback_balacc_bfp_risk_mod <- lmer(p_target_ba ~ mom_ed + income + sex + age_yr + block*risk_status_mom + block*dxa_total_body_perc_fat + (1|sub), data = r01_nback[r01_nback$ses == 1, ])
nback_balacc_bfp_risk_anova <- Anova(nback_balacc_bfp_risk_mod, test.statistic = 'F')

r01_nback_bfp_ses$balacc_pred_both <- predict(nback_balacc_bfp_risk_mod, type = 'response')

# d'
nback_dprime_bfp_risk_mod <- lmer(dprime ~ mom_ed + income + sex + age_yr + block*risk_status_mom + block*dxa_total_body_perc_fat + (1|sub), data = r01_nback[r01_nback$ses == 1, ])
nback_dprime_bfp_risk_anova <- Anova(nback_dprime_bfp_risk_mod, test.statistic = 'F')
