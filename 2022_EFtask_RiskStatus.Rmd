...
# Exploratory Analyses: BMI-Z score (reviewer comment)
...
```{r gng_fa_bmiz_mod, echo=FALSE, results='asis'}
kable(round(gng_fa_bmiz_sum$coefficients, digits = 3), "latex",  digits = 3, caption = 'Go-NoGo Percent False Alarms - Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
```{r gng_hits_bmiz_mod, echo=FALSE, results='asis'}
kable(round(gng_hits_bmiz_sum$coefficients, digits = 3), "latex",  digits = 3, caption = 'Go-NoGo - Percent Hits - Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
```{r gng_hits_rt_bmiz_mod, echo=FALSE, results='asis'}
kable(round(gng_rt_bmiz_sum$coefficients, digits = 3), "latex",  digits = 3, caption = 'Go-NoGo - Go Reaction Time', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
```{r gng_dprime_bmiz_mod, echo=FALSE, results='asis'}
kable(round(gng_dprime_bmiz_sum$coefficients, digits = 3), "latex",  digits = 3, caption = "Go-NoGo - d'", booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
```{r sst_ssrt_bmiz_mod, echo=FALSE, results='asis'}
kable(round(sst_ssrt_bmiz_sum$coefficients, digits = 3), "latex",  digits = 3, caption = 'Stop-Signal Task SSRT - Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
\
...
```{r sst_ssd_bmiz_mod, echo=FALSE, results='asis'}
kable(round(sst_ssd_bmiz_sum$coefficients, digits = 3), "latex",  digits = 3, caption = 'Stop-Signal Task SSD - Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
```{r nback_balacc_bmiz_mod, echo=FALSE, results='asis'}
kable(round(nback_balacc_bmiz_sum$coefficients, digits = 3), "latex",  digits = 3, caption = 'Nback Balanced Accuracy - Body Fat Percentage x Load', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
```{r nback_dprime_bmiz_mod, echo=FALSE, results='asis'}
kable(round(nback_dprime_bmiz_sum$coefficients, digits = 3), "latex",  digits = 3, caption = 'Nback Balanced Accuracy - Body Fat Percentage x Load', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
