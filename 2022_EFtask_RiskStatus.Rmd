...
```{r gng_fa_bfp_plot, echo=FALSE, include = TRUE, fig.height = 4, fig.width = 4}
gng_fa_bfp_plot
```
...
```{r sst_ssrt_bfp_plot, echo=FALSE, include = TRUE, fig.height = 4, fig.width = 4}
sst_ssrt_bfp_plot
```
...
```{r nback_dprime_bfp_plot, echo=FALSE, include = TRUE, fig.height = 4, fig.width = 4}
