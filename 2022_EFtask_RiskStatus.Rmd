...
# Exploratory Analyses with Total Body Fat Percentage
...
kable(round(gng_fa_bfp_sum$coefficients, 3), "latex",  digits = 3, caption = 'Go-NoGo Percent False Alarms - Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(gng_hits_bfp_sum$coefficients, 3), "latex",  digits = 3, caption = 'Go-NoGo - Percent Hits - Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(gng_rt_bfp_sum$coefficients, 3), "latex",  digits = 3, caption = 'Go-NoGo - Go Reaction Time', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(gng_dprime_bfp_sum$coefficients, 3), "latex",  digits = 3, caption = "Go-NoGo - d'", booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(sst_ssrt_bfp_sum$coefficients, 3), "latex",  digits = 3, caption = 'Stop-Signal Task SSRT - Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(sst_ssrt_bfp_EDsum$coefficients), "latex",  digits = 3, caption = 'Stop-Signal Task SSRT - ED x Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
```{r sst_ssrt_bfp_EDmod_noint, echo=FALSE, results='asis'}
kable(round(sst_ssrt_bfp_EDsum_noint$coefficients), "latex",  digits = 3, caption = 'Stop-Signal Task SSRT - ED + Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(sst_ssrt_bfp_PSsum$coefficients), "latex",  digits = 3, caption = 'Stop-Signal Task SSRT - PS x Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```

\FloatBarrier

```{r sst_ssrt_bfp_PSmod_noint, echo=FALSE, results='asis'}
kable(round(sst_ssrt_bfp_PSsum_noint$coefficients), "latex",  digits = 3, caption = 'Stop-Signal Task SSRT - PS + Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(sst_ssd_bfp_sum$coefficients), "latex",  digits = 3, caption = 'Stop-Signal Task SSD - Body Fat Percentage', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(sst_ssd_bfp_EDsum$coefficients), "latex",  digits = 3, caption = 'Stop-Signal Task SSD - Body Fat Percentage x ED', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```

\FloatBarrier
```{r sst_ssd_bfp_EDmod_noint, echo=FALSE, results='asis'}
kable(round(sst_ssd_bfp_EDsum_noint$coefficients), "latex",  digits = 3, caption = 'Stop-Signal Task SSD - Body Fat Percentage + ED', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
emmeans(sst_ssd_bfp_EDmod_noint, pairwise ~ ED)
test(emtrends(sst_ssd_bfp_EDmod_noint, ~ dxa_total_body_perc_fat, var = 'dxa_total_body_perc_fat'))
```
...
kable(round(sst_ssd_bfp_PSsum$coefficients), "latex",  digits = 3, caption = 'Stop-Signal Task SSD - Body Fat Percentage x PS', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(sst_ssd_bfp_PSsum_noInt$coefficients), "latex",  digits = 3, caption = 'Stop-Signal Task SSD - Body Fat Percentage + PS', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
emmeans(sst_ssd_bfp_PSmod_noInt, pairwise ~ PS)
test(emtrends(sst_ssd_bfp_PSmod_noInt, ~ dxa_total_body_perc_fat, var = 'dxa_total_body_perc_fat'))
```
...
kable(round(nback_balacc_bfp_sum$coefficients, 3), "latex",  digits = 3, caption = 'Nback Balanced Accuracy - Body Fat Percentage x Load', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
...
kable(round(nback_dprime_bfp_sum$coefficients, 3), "latex",  digits = 3, caption = 'Nback Balanced Accuracy - Risk Status x Load', booktabs=TRUE) %>%
  kable_styling(latex_options = c("HOLD_position", "repeat_header"))
```
